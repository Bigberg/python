...
#query = '''insert into staff_table (name,age,phone,dpet,enroll_date) values ('Li Si',22,'13423456789','Engineer','2014-09-08')'''
...
def query_function(query):
    ...
    if capital_string == "select":
        ...
        print("Error! \033[31;1m {} \033[0m NO such function!".format(query_dict['query_action']))
        exit()
    return query_dict
